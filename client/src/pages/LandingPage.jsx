        ...
        <div className="col-span-1 lg:col-span-1">
          ...
          <div className="bg-white p-4 shadow rounded">
            ...
            <ul className="list-none p-0 m-0">
              <li className="flex items-center p-3 border-b border-gray-300">
                <span className="mr-3">📅</span>
                <div>
                  <span className="block font-medium">Meditation Session</span>
                  <span className="text-gray-600 text-sm">Tomorrow, 10:00 AM</span>
                </div>
              </li>
              <li className="flex items-center p-3 border-b border-gray-300">
                <span className="mr-3">👥</span>
                <div>
                  ...
                  <span className="text-gray-600 text-sm">Wed, Sep 12, 3:00 PM</span>
                </div>
              </li>
              <li className="flex items-center p-3">
                ...
                <div>
                  ...
                  <span className="text-gray-600 text-sm">Fri, Sep 14, 5:00 PM</span>
                </div>
              </li>
            </ul>
          </div>
